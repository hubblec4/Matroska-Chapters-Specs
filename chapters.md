...
Only one more condition MUST be met, the `ChapterSegmentEditionUID` MUST be set with a valid `EditionUID` from the linked Matroska file/Segment.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTc5ODU1MTYsLTE2MjQ1NTg1NjIsLT
