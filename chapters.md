...
The end timestamp MUST be greater than the start timestamp otherwise the `Chapter` duration would be negative which is illegal. If a `Chapter` duration 0 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTU1MzM1OTk2LDEwNTA0MzY4MTUsMTkwND
