...
The `ChapterFlagHidden` works a bit different as the `EditionFlagHidden`. Each The `ChapterFlagHidden` is indep.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNDQ1ODIzMjgsMTE0NTU3MjY5MywtNj
