...
When the `EditionFlagHidden Flag` is set to `true` then is
the `Edition` hidden and SHOULD not be available in a `Matroska Player`.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA5ODQxMjYyLDE4ODUyOTkyNTcsMTY1Mz
...
NzUsOTEzMTg5NzMzLC0xNjgwOTEzNTYxLC0xNTM4MTY2NDA1LC
0yMTI2OTEwODIsMzU4MDg5NzEwLDQ5MjMwMzk3NSwtMjA3OTE3
OTM2Nl19
-->