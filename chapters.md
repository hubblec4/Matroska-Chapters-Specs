...
For `Simple Chapters` with `ChapterFlagHidden Flag` is set to `false` the `Chapter` is visible as chapter mark in the timeline.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU4ODU1NDkwNywtMTY0ODg0NzkxNiwxNT
